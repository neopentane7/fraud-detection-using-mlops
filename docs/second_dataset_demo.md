...
Kaggle runs). Our **0.774 / 0.551** land exactly on it — the generalized pipeline
...
The pipeline is now genuinely **dataset-agnostic**: the identical
...
(51/51 tests still green); the second dataset is just another profile in
`params.yaml`.
